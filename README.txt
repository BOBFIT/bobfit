...
History:
Open Log and use the History switches to view previous meals, workout logs, and
weight/body entries. Meal history is grouped by day, workout history keeps the
exercise set details, and weight history shows each previous body metric entry.
