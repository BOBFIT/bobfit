...
function motraWorkoutsFromText(text) {
  ...
  if (!workouts.length) throw new Error(`No Motra workouts found in the pasted text. I read ${rows.length} rows, but could not find Workout Start and All Sets together.`);
  return workouts;
}
